# -*- coding: utf-8 -*-
""" gtorch_utils/models/managers/callbacks/test/test_plot_tensorboard """

import unittest
from unittest.mock import patch

from gtorch_utils.models.managers.callbacks.plot_tensorboard import PlotTensorBoard


class Test_PlotTensorBoard(unittest.TestCase):

    @patch('gtorch_utils.models.managers.callbacks.plot_tensorboard.logger')
    @patch('gtorch_utils.models.managers.callbacks.plot_tensorboard.SummaryWriter')
