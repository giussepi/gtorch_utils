...
from gtorch_utils.datasets.segmentation.datasets.lits17.datasets.base import BaseLiTS17Dataset
...
class LiTS17Dataset(BaseLiTS17Dataset):
    ...
    gtorch_utils.datasets.segmentation.datasets.lits17.processors.LiTS17MGR
...
class LiTS17CropDataset(BaseLiTS17Dataset):
    """
    Dataset for the LiTS17 dataset created through
    gtorch_utils.datasets.segmentation.datasets.lits17.processors.LiTS17CropMGR
