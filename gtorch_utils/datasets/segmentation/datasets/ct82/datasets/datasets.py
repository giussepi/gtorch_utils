...
class CT82Dataset(DatasetTemplate):
    """
    Dataset for the cT82 dataset created through
    gtorch_utils.datasets.segmentation.datasets.ct82.processors.CT82MGR->process
    ...
    def __init__(self, **kwargs):
        ...
        Kwargs:
            ...
            original_masks    <bool>: If original_masks == cotraining_mask == True, then both the original
                                      ...
                                      Default False
            transform <callable, None>: Data augmentation transforms. See gtorch_utils.datasets.segmentation.datasets.ct82.settings.
                                      Defaullt None
