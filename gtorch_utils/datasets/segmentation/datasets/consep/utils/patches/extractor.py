...
from gtorch_utils.datasets.segmentation.datasets.consep.utils.utils import cropping_center
...
class PatchExtractor:
    ...
    def __init__(self, win_size, step_size, patch_type=PatchExtractType.MIRROR, debug=False):
        ...
        Args:
            ...
            patch_type <str>: Patch type to extract. See gtorch_utils.datasets.segmentation.datasets.consep.utils.patches.constants.py -> PatchExtractType
