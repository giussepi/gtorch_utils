...
from gtorch_utils.datasets.segmentation.datasets.consep.datasets.constants import Dataset
from gtorch_utils.datasets.segmentation.datasets.consep.datasets.datasets import get_dataset
from gtorch_utils.datasets.segmentation.datasets.consep.utils.patches.constants import PatchExtractType
from gtorch_utils.datasets.segmentation.datasets.consep.utils.patches.extractor import PatchExtractor
from gtorch_utils.datasets.segmentation.datasets.consep.utils.utils import rm_n_mkdir
    ...
    def __init__(self, **kwargs):
        ...
        kwargs:
            ...
            ann_percentage <float>: percentage of annotations to work with (float number in range ]0, 1]).
                                    Default 1.
            database_name <str>: Name of the dataset to process. See gtorch_utils.datasets.segmentation.datasets.consep.datasets.constants.py -> Dataset
