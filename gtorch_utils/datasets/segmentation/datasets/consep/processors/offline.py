...
class CreateDataset:
    """
    Processes the patches from CoNSeP dataset created by gtorch_utils.datasets.segmentation.datasets.consep.utils.patches.patches.ProcessDataset
    ...
    def __init__(self, **kwargs):
        ...
        Kwargs:
            train_path        <str>: path to the folder containing the training NumPy files created by
                                     gtorch_utils.datasets.segmentation.datasets.consep.utils.patches.patches.ProcessDataset
            ...
            test_path         <str>: path to the folder containing the testing NumPy files created by
                                     gtorch_utils.datasets.segmentation.datasets.consep.utils.patches.patches.ProcessDataset. Default ''
