# -*- coding: utf-8 -*-
""" nns/models/mixins/test/test_init_mixin.py """
...
class Test_InitMixin(unittest.TestCase):
    ...
    @patch('gtorch_utils.nns.models.mixins.init_mixin.init_weights')
    @patch('gtorch_utils.nns.models.mixins.init_mixin.UNet3InitMethod')
