# -*- coding: utf-8 -*-
""" gtorch_utils/nns/mixins/managers/base """
...
class BaseModelMGR(SanityChecksMixin, CheckPointMixin, DataLoggerMixin, SubDatasetsMixin):
    """
    Base segmentation model manager
